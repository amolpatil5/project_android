...
import com.amp.syadav.MediumViewActivity;
...
public class ImageGridViewAdapter extends BaseAdapter {
    ...
    public CurrentAppData currentAppData;
    public  Activity activity;


    public ImageGridViewAdapter(Activity activity,CurrentAppData currentAppData) {
    ...
    class ImageGridViewCellOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
           ...
           // intent.putExtra("currendata", currentAppData);
