...
//		                return SocialFragment.newInstance("https://www.youtube.com/user/shivpalsinghyad");
		        ...
		        public CharSequence getPageTitle(int position) 
		        {
		        	...
		        	switch (position) {
					case 0:
						return ctx.getResources().getString(R.string.FACEBOOK);
					case 1:
						return ctx.getResources().getString(R.string.GOOGLE_PLUS);
					case 2:
						return ctx.getResources().getString(R.string.TWITTER);
//					case 3:
//						return "Youtube";
//						
					default:
